...
interface EditBakerInfoModalProps {
  onClose: () => void;
  onSubmit: (data: BakerFormData) => void;
  initialData: BakerFormData;
}
...
export default function EditBakerInfoModal({ onClose, onSubmit, initialData }: EditBakerInfoModalProps) {
  const [name, setName] = useState(initialData.name);
  const [avatar, setAvatar] = useState(initialData.avatar);
  const [selectedBreads, setSelectedBreads] = useState<string[]>(initialData.specialties);
    ...
    <div className="become-baker-modal-overlay" onClick={handleOverlayClick}>
      <div className="become-baker-modal-content">
        ...
        <div className="become-baker-modal-header">
          <h2 className="become-baker-modal-title">编辑主理人信息</h2>
